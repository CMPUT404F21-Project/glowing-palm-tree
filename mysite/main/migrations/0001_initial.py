# Generated by Django 3.1.6 on 2021-10-18 01:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='postlist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('postList', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.postlist')),
            ],
        ),
    ]
